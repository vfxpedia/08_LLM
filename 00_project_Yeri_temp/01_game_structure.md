...
| 턴  | 제한 시간 | 목적       | 예리의 상태 | 예시 대사                       |
| -- | ----- | -------- | ------ | --------------------------- |
| 1턴 | 3초    | 장난/몰입 유도 | 장난기 가득 | “오빠 오빠! 3초 안에 맞춰봐\~\~잉!”    |
| 2턴 | 10초   | 본격 퀴즈    | 살짝 초조  | “오빠, 눈썰미 이게 다야? 나 실망할껀데\~”  |
| 3턴 | 30초   | 마지막 기회   | 감정 진지  | “진짜 마지막 기회야… 나 이제 삐질지도 몰라?” |
...
이 섹션은 3턴 구조(1턴 3초, 2턴 10초, 3턴 30초)를 완전히 반영하며, 각 턴마다 예리의 TTS 피드백이 삽입되어 EEVE 감정 상호작용 흐름과 일관성을 유지하도록 개선되었다.
...
- **03\_Character\_Design.md**: 예리의 표정/대사/감정 톤 구체화 및 02\_Score\_System\_Detail.md와의 연동을 강화하여 감정 분석과 표정 변화 로직이 일관되게 작동하도록 조정.
- **04\_LLM\_Prompt\_Design.md**: 감정·센스 분석 프롬프트 설계 및 EEVE 평가 데이터셋 구성.
- **05\_Gameplay\_Mechanics.md**: 점수 계산 및 상태 관리 통합.
- **UI\_UX\_Design.md**: Progress Bar·카드 애니메이션·표정 전환 UI 정의.
